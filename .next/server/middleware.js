...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2Fworkspace_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
async function middleware(req) {
    ...
    if (!session && !sessionRoutes.includes(path) && path.startsWith("/admin")) {
        return NextResponse.redirect(new URL("/login", req.url));
    } else if (session && sessionRoutes.includes(path) || path === "/admin") {
        return NextResponse.redirect(new URL("/admin/hizmetler", req.url));
    }
    return NextResponse.next();
}

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2Fworkspace&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2Fworkspace_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/middleware",
            handler,
...
var _uuid = __webpack_require__(467);
