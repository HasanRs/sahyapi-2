"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{99978:function(e,t,r){r.d(t,{IO:function(){return iX},JU:function(){return iv},PL:function(){return sn},Xo:function(){return i2},ad:function(){return iT},ar:function(){return iZ},hJ:function(){return iw},oe:function(){return sa},pl:function(){return si},r7:function(){return ss}});var n,i,s=r(13626),a=r(45538),o=r(56914),l=r(8745),u=r(30613);r(62601);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new E(_.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new n6({next:r=>{t.enqueueAndForget(()=>nD(e,a)),r.fromCache&&"server"===n.source?i.reject(new E(_.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),a=new nV(r,s,{includeMetadataChanges:!0,Z_:!0});return nb(e,a)})(await ii(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new st(t,n,e,r)))}function si(e,t,r){var n;e=ic(e,ip);let i=ic(e.firestore,iE),s=(n=e.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t;return so(i,[(function(e,t,r,n,i,s={}){let a,o;let l=e.wu(s.merge||s.mergeFields?2:0,t,r,i);iq("Data must be an object, but it was:",l,n);let u=iP(n,l);if(s.merge)a=new er(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=iB(t,n,r);if(!l.contains(i))throw new E(_.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);iG(e,i)||e.push(i)}a=new er(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iD(new eb(u),a,o)})(iM(i),"setDoc",e._key,s,null!==e.converter,r).toMutation(e._key,tA.none())])}function ss(e,t,r,...n){e=ic(e,ip);let i=ic(e.firestore,iE),s=iM(i);return so(i,[("string"==typeof(t=(0,l.m9)(t))||t instanceof iA?function(e,t,r,n,i,s){let a=e.wu(1,t,r),o=[iB(t,n,r)],u=[i];if(s.length%2!=0)throw new E(_.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iB(t,s[e])),u.push(s[e+1]);let h=[],c=eb.empty();for(let e=o.length-1;e>=0;--e)if(!iG(h,o[e])){let t=o[e],r=u[e];r=(0,l.m9)(r);let n=a.mu(t);if(r instanceof iF)h.push(t);else{let e=iO(r,n);null!=e&&(h.push(t),c.set(t,e))}}let d=new er(h);return new iR(c,d,a.fieldTransforms)}(s,"updateDoc",e._key,t,r,n):function(e,t,r,n){let i=e.wu(1,t,r);iq("Data must be an object, but it was:",i,n);let s=[],a=eb.empty();W(n,(e,n)=>{let o=iK(t,e,r);n=(0,l.m9)(n);let u=i.mu(o);if(n instanceof iF)s.push(o);else{let e=iO(n,u);null!=e&&(s.push(o),a.set(o,e))}});let o=new er(s);return new iR(a,o,i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tA.exists(!0))])}function sa(e){return so(ic(e.firestore,iE),[new tO(e._key,tA.none())])}function so(e,t){return function(e,t){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>nz(await ir(e).then(e=>e.syncEngine),t,r)),r.promise}(iI(e),t)}new WeakMap,function(e=!0){d=s.Jn,(0,s.Xd)(new a.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new iE(new A(t.getProvider("auth-internal")),new D(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new E(_.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ef(e.options.projectId,t)}(i,r),i);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),(0,s.KN)(h,"4.2.0",void 0),(0,s.KN)(h,"4.2.0","esm2017")}()}}]);